...
<div id="jwplayerDiv" style="height: auto; text-align: center;"></div>
...
function fetchVideoData(id, callback) {
  const url = '../stream.php?id=' + id;
  fetch(url)
...
function setupPlayer(videoData) {
  ...
  if (videoData.licenseurl) {
    playerConfig.drm = {
      widevine: {
        url: videoData.licenseurl
      },
      playready: {
        url: videoData.licenseurl
      }
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (id) {
    fetchVideoData(id, function (videoData) {
      if (videoData) {
    ...
    console.error('No ID specified in the URL');
  }
});
</script>
         <style>
